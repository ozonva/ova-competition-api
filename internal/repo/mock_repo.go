...
// Source: ozonva/ova-competition-api/internal/repo (interfaces: Repo)
...
import (
	context "context"
	models "ozonva/ova-competition-api/internal/models"
	reflect "reflect"
...
func (m *MockRepo) AddEntities(arg0 context.Context, arg1 []models.Competition) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(arg0 context.Context, arg1 uint64) (*models.Competition, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(arg0 context.Context, arg1, arg2 uint64) ([]models.Competition, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) UpdateEntity(arg0 context.Context, arg1 uint64, arg2 *models.Competition) error {
	m.ctrl.T.Helper()
