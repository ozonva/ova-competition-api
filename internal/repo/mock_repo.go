...
func (m *MockRepo) AddEntities(entities []models.Competition) error {
	m.ctrl.T.Helper()
...
func (m *MockRepo) DescribeEntity(entityId uint64) (*models.Competition, error) {
	m.ctrl.T.Helper()
...
func (m *MockRepo) ListEntities(limit, offset uint64) ([]models.Competition, error) {
	m.ctrl.T.Helper()
